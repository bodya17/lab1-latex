...
\usepackage{amsmath}
\usepackage{color}                       % Під"єднання кольорів
\usepackage[left=3cm,right=1.5cm,top=2cm,bottom=2cm]{geometry} % поля страницы
\usepackage{indentfirst}                 % Всі абзаци з відступом
\parindent=1.25cm                        % Розмір абзацного відступу
\renewcommand{\arraystretch}{1.5} % задання стандартного відступу між рядками в таблиці
\pagenumbering{gobble} % виключення нумерації сторінок
